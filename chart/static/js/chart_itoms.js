...
$(function () {
    ...
    //图表测试框
    /*
     var chart_test = echarts.init(document.getElementById('itoms_test'));
     chart_test.showLoading();
     load_ver_bar_chart(chart_test, com_option, "ver_bar", "常规变更", '2016-06-28');
     */
    ...
    // console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>');
    // console.log(com_option.toolbox.feature.magicType.icon);

    //基于准备好的dom，初始化echarts实例
    // var chart_xbank = echarts.init(document.getElementById('itoms_xbank'));
    // chart_xbank.showLoading();
    // load_line_chart('itoms_xbank', com_option, "line", "chg");
    // load_geo_chart('itoms_xbank', com_option, "geo", "Xbank事件工单", '20160701');
});

//加载水平line曲线
function load_line_chart(chart_div, com_option, chart_type, itoms_type) {
    ...
    $.getJSON("/server_itoms", {chart_type: chart_type, itoms_type: itoms_type}, function (result) {
